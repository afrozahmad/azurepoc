...
echo "HBASE_CONF_DIR=/etc/hbase/conf" | sudo tee -a /etc/environment
...
download_file http://d3kbcqa49mib13.cloudfront.net/spark-2.0.2-bin-hadoop2.6.tgz /tmp/spark-2.0.2-bin-hadoop2.6.tgz
...
echo "export SPARK_DIST_CLASSPATH=$(hadoop classpath)$(hbase classpath)"
echo "eexport SPARK_MAJOR_VERSION=2"
